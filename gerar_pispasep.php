            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="pis_pasep_titular">Número do Pis/Pasep</label>
                  <input type="text" class="form-control titular" id="pis_pasep_titular">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary criar_personagem"  style="text-align: center;" href="#" role="button">GERAR PIS/PASEP</a>
            </div>
          </form>
        </div>
      </main><!-- /.container -->
