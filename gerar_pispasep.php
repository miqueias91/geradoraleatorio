...
<head>
  ...
  ?>
  <title>Innovate Soft - Gerador Online de Pis/Pasep</title>
...
<body>
  ...
  <main role="main" class="d-flex" id="wrapper">
    ...
    <section id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Gerador Online de Pis/Pasep</h1>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="pis_pasep_">Número do Pis/Pasep</label>
                  <input type="text" class="form-control pis_pasep" id="pis_pasep_">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary clipboard"  style="text-align: center;" href="#" role="button" data-clipboard-target="#pis_pasep_">COPIAR</a>
              <a class="btn btn-primary criar_pispasep"  style="text-align: center;" href="#" role="button">GERAR PIS/PASEP</a>
            </div>
          </form>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#pis_pasep_").val(gerarNumeroPIS_PASEP());
      //ACAO DO BOTAO CRIAR PERSONAGEM
      $('.criar_pispasep').click(function(){
        $("#pis_pasep_").val(gerarNumeroPIS_PASEP());
      });  
    });
  </script>
