...
<head>
  ...
  <title>Innovate Soft - Gerador Online de Certidão de Obito</title>
...
<body>
  ...
  <main role="main" class="d-flex" id="wrapper">
    ...
    <section id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Gerador Online de Certidão de Obito</h1>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="certidaoobito_">Número da Certidão de Obito</label>
                  <input type="text" class="form-control certidao" id="certidaoobito_">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary criar_certidaoobito"  style="text-align: center;" href="#" role="button">GERAR CERTIDÃO DE OBITO</a>
            </div>
          </form>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#certidaoobito_").val(gerarNumeroCertidao());
      //ACAO DO BOTAO CRIAR PERSONAGEM
      $('.criar_certidaoobito').click(function(){
        $("#certidaoobito_").val(gerarNumeroCertidao());
      });    
    });
  </script>
