...
<body>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="cnpj_titular">Número do CNPJ</label>
                  <input type="text" class="form-control titular" id="cnpj_titular">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary criar_personagem"  style="text-align: center;" href="#" role="button">GERAR CNPJ</a>
            </div>
          </form>
        </div>
      </main><!-- /.container -->
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#cnpj_titular").val(gerarNumeroCNPJ());
