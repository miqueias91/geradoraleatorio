...
<head>
  ...
  ?>
  <title>Innovate Soft - Gerador Online de Certidão de Nascimento</title>
...
<body>
  ...
  <main role="main" class="d-flex" id="wrapper">
    ...
    <section id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Gerador Online de Certidão de Nascimento</h1>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="certidaonascimento_">Número da Certidão de Nascimento</label>
                  <input type="text" class="form-control certidao" id="certidaonascimento_">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary clipboard"  style="text-align: center;" href="#" role="button" data-clipboard-target="#certidaonascimento_">COPIAR</a>
              <a class="btn btn-primary criar_certidaonascimento"  style="text-align: center;" href="#" role="button">GERAR CERTIDÃO DE NASCIMENTO</a>
            </div>
          </form>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#certidaonascimento_").val(gerarNumeroCertidao());
      //ACAO DO BOTAO CRIAR PERSONAGEM
      $('.criar_certidaonascimento').click(function(){
        $("#certidaonascimento_").val(gerarNumeroCertidao());
      });    
    });
  </script>
