...
<body>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="te_titular">Número do Título de Eleitor</label>
                  <input type="text" class="form-control titular" id="te_titular">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary criar_personagem"  style="text-align: center;" href="#" role="button">GERAR TÍTULO DE ELEITOR</a>
            </div>
          </form>
        </div>
      </main><!-- /.container -->
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#te_titular").val(gerarNumeroTituloEleitor());
