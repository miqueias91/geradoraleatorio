...
<head>
  ...
  ?>
  <title>Innovate Soft - Gerador Online de CPF</title>
...
<body>
  ...
  <main role="main" class="d-flex" id="wrapper">
    ...
    <section id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Gerador Online de CPF</h1>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="cpf_">Número do CPF</label>
                  <input type="text" class="form-control cpf" id="cpf_">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary clipboard"  style="text-align: center;" href="#" role="button" data-clipboard-target="#cpf_">COPIAR</a>
              <a class="btn btn-primary criar_cpf"  style="text-align: center;" href="#" role="button">GERAR CPF</a>
            </div>
          </form>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#cpf_").val(gerarNumeroCPF());
      //ACAO DO BOTAO CRIAR PERSONAGEM
      $('.criar_cpf').click(function(){
        $("#cpf_").val(gerarNumeroCPF());
      });    
    });
  </script>
