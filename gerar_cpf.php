...
<body>
            ...
            <fieldset>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="cpf_titular">Número do CPF</label>
                  <input type="text" class="form-control titular" id="cpf_titular">
                </div>
              </div>
            </fieldset>

            <div class="text-center">
              <a class="btn btn-primary criar_personagem"  style="text-align: center;" href="#" role="button">GERAR CPF</a>
            </div>
          </form>
        </div>
      </main><!-- /.container -->
  ...
  <script type="text/javascript">
    $( document ).ready(function() { 
      $("#cpf_titular").val(gerarNumeroCPF());
